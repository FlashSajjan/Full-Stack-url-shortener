...
const CreateNewShorten = ({ setOpen, refetch }) => {
  ...
  const createShortUrlHandler = async (data) => {
    setLoading(true);
    try {
        console.log('Creating short URL for:', data.originalUrl);
        ...
        const { data: res } = await api.post("/api/urls/shorten", data, {
          ...
          console.log('Short URL from backend:', res.shortUrl);
          
          const shortenUrl = `${import.meta.env.VITE_REACT_FRONT_END_URL}/s/${res.shortUrl}`;
          console.log('Full shortened URL:', shortenUrl);
        ...
        let errorMessage = "Create ShortURL Failed";
